const Encabezado = () => {
  return (
    <header className="relative overflow-hidden bg-transparent py-24 px-6 text-center">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 -z-10 h-[30rem] w-[30rem] rounded-full bg-violet-600/20 blur-[100px] animate-pulse" />
      ...
      <div className="mx-auto max-w-3xl relative z-10 group">
        ...
        <h1 className="text-5xl font-extrabold tracking-tight text-white sm:text-7xl mb-6 transition-transform duration-700 hover:scale-105">
          La programacion <span className="bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent drop-shadow-[0_0_20px_rgba(6,182,212,0.5)]">Programación</span>
        </h1>
        ...
        <div className="mt-12 h-px w-full max-w-md mx-auto bg-gradient-to-r from-transparent via-cyan-500/50 to-transparent shadow-[0_0_10px_rgba(6,182,212,0.5)]"></div>
      </div>
    </header>
  );
};
